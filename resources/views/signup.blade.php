...
<body style="background-color: #181c24">
    <br> <br>
    <div class="row justify-content-center">
        <div class="col-lg-4">
            <main class="form-login">
                <h1 class="h3 mb-3 fw-normal text-center" style="color: #ffffff">Sign Up</h1>
                    <form action="{{ route('user-simpan-tamu') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @endforeach
                        <small class="d-block mt-2" style="color: #ffffff">Already Registered? <a href="{{ route("user-login") }}" style="color: rgb(0, 81, 255)">Log In</a></small>
