    ...
    <div class="row justify-content-center">
        <div class="col-lg-4">
            ...
            <main class="form-login">
                <h1 class="h3 mb-3 fw-normal text-center" style="color: #ffffff">Log In</h1>
                ...
                <small class="d-block mt-2" style="color: #ffffff">Not Registered? <a href="{{ route("user-signup") }}" style="color: rgb(0, 81, 255)">Sign Up</a></small>
            </main>
        </div>
    </div>
</body>
